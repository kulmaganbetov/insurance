...
function SkeletonBlock({ className }: { className?: string }) {
  return (
    <div
      className={`bg-white rounded-2xl animate-pulse ${className ?? ''}`}
    >
      <div className="p-6 space-y-4">
        <div className="h-5 w-1/3 bg-slate-200 rounded" />
        <div className="h-32 bg-slate-200/60 rounded-lg" />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex gap-3">
            <Link
              href="/calculator"
              className="flex items-center gap-2 px-4 py-2.5 bg-slate-200 hover:bg-slate-300 text-slate-900 rounded-xl transition-colors text-sm font-medium"
            >

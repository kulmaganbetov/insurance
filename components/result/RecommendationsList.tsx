...
const iconColors = ['text-emerald-600', 'text-blue-400', 'text-yellow-400'];
const bgColors = [
  'bg-emerald-500/10',
  'bg-blue-500/10',
  'bg-yellow-500/10',
...
export default function RecommendationsList({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
      <h3 className="text-slate-900 text-lg font-semibold mb-4">Ұсыныстар</h3>
        ...
        {recommendations.slice(0, 3).map((rec, i) => {
          ...
          return (
            <motion.div
              ...
              className={`${bgColors[i % bgColors.length]} border border-slate-200 rounded-xl p-4`}
            >
              <div
